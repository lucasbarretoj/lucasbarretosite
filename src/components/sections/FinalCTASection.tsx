    ...
    <section className="final-cta section" id="contato" aria-labelledby="contact-title">
      <div className="container final-cta__grid">
        ...
        <form className="contact-form" onSubmit={handleSubmit}>
          <label>Seu nome *<input name="name" required placeholder="Como posso te chamar?" /></label>
          <label>WhatsApp ou e-mail *<input name="contact" required placeholder="Seu melhor contato" /></label>
          <label>Empresa / projeto<input name="company" placeholder="Opcional" /></label>
